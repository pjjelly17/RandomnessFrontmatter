                ...
                new PropertyKeyModal(
                    ...
                    async (key, picked) => {
                        try {
                            ...
                            // Roll, then write into frontmatter. Upstream's
                            // public API has no rollIntoProperty/excludeUsed,
                            // so the roll + exclude-used retry + frontmatter
                            ...
                            if (
                                ...
                                while (
                                    ...
                                    rollResult = await plugin.api.roll(
                                        picked.name
                                    );
                                }
                            }
